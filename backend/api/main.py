...
from backend.api.routes import recommendations, run_workflow, newsletter, user_vector_update, test_recommendation
...
app.include_router(test_recommendation.router, prefix="/test", tags=["test"])
